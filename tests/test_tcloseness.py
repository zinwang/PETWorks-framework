...
def testMeasureTClosenessNumeral():
    anonymizedData = pd.read_csv("data/merit.csv", sep=";", skipinitialspace=True)
    attributeTypes = {
        "Name": QUASI_IDENTIFIER,
        "Merit": SENSITIVE_ATTRIBUTE
    }
...
def testMeasureTClosenessHierarchical():
    anonymizedData = pd.read_csv("data/disease.csv", sep=";", skipinitialspace=True)
